...
function onSubmit(){
    determineSign(day, month, birthdayResult);
    if (birthdayResult == "noChoice" || name == "" || month == "noChoice" || day == "noChoice"){
...
function determineSign(day, month){
    if (month == "1" && day >= "29" || month == "3" && day == "31" || month == "5" && day == "31" || month == "8" && day == "31" || month == "10" && day == "31"){
        ...
        userSign = null;
        return userSign;
    } else if (month == "11" && "22" <= day || month == "0" && "1" <= day <= "19"){
        userSign = signs[11];
        // Capricorn
    } else if (month == "0" &&  "20" <= day || month == "1" && day <= "18"){
        userSign = signs[0];
        // Aquarius
    } else if (month == "1" && "19" <= day || month == "2" && day <= "20"){
        userSign = signs[1];
        // Pisces
    } else if (month == "2" && "21" <= day || month == "3" && day <= "19"){
        userSign = signs[2];
        // Aries
    } else if (month == "3" && "20" <= day || month == "4" && day <= "20"){
        userSign = signs[3];
        // Taurus
    } else if (month == "4" && "21" <= day || month == "5" && day <= "20"){
        userSign = signs[4];
        // Gemini
    } else if (month == "5" && "21" <= day || month == "6" && day <= "22"){
        userSign = signs[5];
        // Cancer
    } else if (month == "6" && "23" <= day || month == "7" && day <= "22"){
        userSign = signs[6];
        // Leo
        ...
        userSign = signs[8];
        // Libra
    } else if (month == "9" && "23" <= day || month == "10" && day <= "21"){
        userSign = signs[9];
        // Scorpio
    } else if (month == "10" && "22" <= day || month == "11" && day <= "21"){
        userSign = signs[10];
        // Sagittarius
    }
    return userSign;
...
function determineHoroscope(userSign, birthdayResult){
    var userHoroscope = "";
